...
var fixations_amount = [5, 10, 15, 30];
...
var changers_amount = [50, 75, 100, 250, 500, 750, 950]; //If you have trouble running my program, try removing the highest number in size and amount of both objects.
...
function preload() {
  track = loadSound('Images/Second.mp3')
}
